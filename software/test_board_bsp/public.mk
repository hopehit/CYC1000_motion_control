...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../NIOS_test_board.sopcinfo
...
# Design Name 
# setting SOPC_NAME is NIOS_test_board
SOPC_NAME := NIOS_test_board
...
# The SOPC System ID 
# setting SOPC_SYSID is 403892959
SOPC_SYSID_FLAG += --id=403892959
ELF_PATCH_FLAG  += --id 403892959

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x10110e8
SOPC_SYSID_FLAG += --sidp=0x10110e8
ELF_PATCH_FLAG  += --sidp 0x10110e8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1554210796
SOPC_SYSID_FLAG += --timestamp=1554210796
ELF_PATCH_FLAG  += --timestamp 1554210796
